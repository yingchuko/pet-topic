  ...
  return (
    <header className="sticky top-0 z-30 bg-cream/80 backdrop-blur-md border-b border-slate-200/50 transition-all">
      <div className="container-layout h-20 flex items-center justify-between">
        ...
        >
          <PawPrint className="w-10 h-10 p-2 rounded-full bg-orange flex items-center justify-center text-white" />
          PetTopic
        </a>
        ...
        >
          ...
          {totalItems > 0 && (
            <span className="absolute -top-1.5 -right-1.5 bg-orange text-white text-xs font-black w-5 h-5 rounded-full flex items-center justify-center animate-bounce">
              {totalItems}
            </span>
          )}
          Cart
